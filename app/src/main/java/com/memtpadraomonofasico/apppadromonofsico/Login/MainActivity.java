...
import com.memtpadraomonofasico.apppadromonofsico.DashBoard;
...
public class MainActivity extends AppCompatActivity {
    ...
    private void login() {
        ...
        if(cursor.getCount()== 0){
            ...
            final ProgressDialog progressDialog = new ProgressDialog(MainActivity.this, R.drawable.circular_progress_bar);
