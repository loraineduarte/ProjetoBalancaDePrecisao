...
public class RegistradorListagemMensagens extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_registrador_listagem_mensagens);
    ...
    private List<Mensagem> todasMensagens() {
        ...
        Cursor cursor = crud.pegaMensagens("Registrador");
