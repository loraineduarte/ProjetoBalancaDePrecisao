package com.memtpadraomonofasico.balancaDePrecisao;
...
import com.memtpadraomonofasico.balancaDePrecisao.Bluetooth.BluetoothActivity;
...
public class BluetoothServicoChamadaPelaAtividade extends Thread {
     ...
     */
    public BluetoothServicoChamadaPelaAtividade() {
        this.server = true;
    }
     ...
     */
    public BluetoothServicoChamadaPelaAtividade(String btDevAddress) {
        this.server = false;
